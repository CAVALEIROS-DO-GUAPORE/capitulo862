        ...
        <div className="space-y-5">
          {news.map((newsItem) => {
            ...
            return (
              <article
                key={newsItem.id}
                className="bg-white rounded-lg border border-slate-200 overflow-hidden hover:border-blue-400 shadow-sm transition-colors"
              >
                {mainImage && (
                  <div className="h-36 sm:h-40 relative bg-slate-50 flex items-center justify-center">
                    <Image
                      src={mainImage}
                      alt={newsItem.title}
                      fill
                ...
                <div className="p-4">
                  ...
                  {newsItem.instagramUrl && (
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg text-sm font-medium transition-colors"
                    >
